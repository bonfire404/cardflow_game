...
# --- PyArmor / PyInstaller Path Handling ---
if getattr(sys, 'frozen', False):
    # If running in a bundle, the root is sys._MEIPASS
    bundle_dir = sys._MEIPASS
else:
    # If running as a script, the root is one level up from this file's folder
